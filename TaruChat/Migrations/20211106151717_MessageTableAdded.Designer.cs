...
namespace TaruChat.Migrations
{
    ...
    [Migration("20211106151717_MessageTableAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaruChat.Models.Message", b =>
                {
                    ...
                    b.Property<string>("EnrollmentsChatID")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("EnrollmentsUserID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("EnrollmentsChatID", "EnrollmentsUserID");
            ...
            modelBuilder.Entity("TaruChat.Models.Message", b =>
                {
                    b.HasOne("TaruChat.Models.Enrollment", "Enrollments")
                        .WithMany()
                        .HasForeignKey("EnrollmentsChatID", "EnrollmentsUserID");
